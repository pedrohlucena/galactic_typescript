...
function forWhichSpaceship(action: string) {
    let spacechipNamesArray: string[] = spaceships.map(currentSpaceship => {
    ...
    let spaceshipChoosed: number = Number(prompt('Você tem as seguintes naves:\n' +
           listOfSpaceships + 
...
function addNewMemberToSpaceship() {
    ...
    let newMember: string = String(prompt('Qual o nome do novo membro?'))
...
function listSpaceshipsInfo() {
    let messageWithSpaceshipInfo: string = ''
